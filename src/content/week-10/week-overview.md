...
**Interaction Question:** Can you explain what you built and why?

---

## Overview

This is presentation week. No new content. No new assignments. Students present their scrollytelling sites — "The Long Way Down" — in 5–7 minute presentations.
...
1. **Live Demo** (2–3 minutes)
   ...
   - Let the work speak first — don't over-explain during the scroll

2. **The Metaphor** (1 minute)
...
3. **Code Walkthrough** (1–2 minutes)
   ...
   - Show the timeline or pin config — explain the values
...
The instructor may point to any line of code and ask: "What does this do?"
If you can't explain it, it's a red flag — but this is a learning moment, not a punishment.
...
| 0:10 | Presentations | 5–7 min each, 1 min transition between |
| — | Q&A | Brief instructor/peer questions after each |
...
**Presentation quality does not add or subtract from the project grade** — but inability to explain code may indicate an integrity concern per the desk critique test.
...
- Celebrate range — a "Kitchen" metaphor and a "Mixtape" metaphor solving the same problem shows the strength of the approach.
...
- Students should keep their GitHub repos public — this is portfolio work
