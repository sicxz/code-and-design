...
Week 9 is a checklist and debugging week, not a "new busywork" week.

### Checkpoints

- **Monday target:** Full ScrollTrigger implementation in place + showpiece pin started
- **Wednesday target:** Debugged, polished, and deployment ready
- **End of week target:** Final site ready for Week 10 showcase

### Use This Checklist As Source Of Truth

- `resources/project-2-implementation-checklist.md`

### In-Class Priority

Most class time should be implementation and blocker removal, with short, focused demos only.
...
To preserve debugging time, keep Week 9 requirements lean:

- Required: `build/build-9-1-the-refinement.md`
- Required: `engage/engage-9-1-peer-review.md`
- Required: Checklist completion in `resources/project-2-implementation-checklist.md` (Checkpoint 4)
- Optional if time is tight: `learn/learn-9-1-scrollytelling-craft.md`
- Optional if time is tight: `reflect/reflect-9-1-visual-notes.md`
