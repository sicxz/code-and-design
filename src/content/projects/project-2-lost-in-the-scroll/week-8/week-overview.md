...
## Cohort Focus (Current Run)

This week is intentionally lean to protect build time and debugging time.

### Checkpoints

- **Monday target:** Full HTML/CSS site, deployed in a new repo, story draft at 90%
- **Wednesday target:** GSAP motion implemented across the full story, story writing complete
- **End of week target:** ScrollTrigger pass started and stable on core sections

### Use These Docs First

- Instructor run-of-show: `resources/scrolltrigger-lecture-plan.md`
- Student checklist: `../week-9/resources/project-2-implementation-checklist.md`
- Instructor execution map: `../project-2-instructor-execution-plan.md`

### Workload Guardrail

No extra busywork deliverables this week beyond what moves the shipped site forward.
...
## Required For Current Run

To keep workload focused, prioritize these items:

- Required: `practice/practice-8-1-the-scroll.md`
- Required: GSAP + writing completion target from `../week-9/resources/project-2-implementation-checklist.md` (Checkpoint 2)
- Optional if time is tight: `learn/learn-8-1-scroll-as-medium.md`
- Optional if time is tight: `reflect/reflect-8-1-visual-notes.md`

If needed, collect one checklist snapshot instead of multiple separate progress artifacts this week.
