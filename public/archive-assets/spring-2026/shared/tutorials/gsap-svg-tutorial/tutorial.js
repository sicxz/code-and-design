...
(function() {
  ...
  function initExportButton() {
    ...
    if (exportButton) {
      exportButton.addEventListener('click', function() {
        ...
        let exportText = 'GSAP SVG ICONS TUTORIAL - MY RESPONSES\n';
  ...
  function initFocusToggle() {
    ...
    if (isFocusMode) {
      ...
      if (textSpan) textSpan.textContent = 'Show Tutorial';
    }
  ...
  function init() {
    ...
    console.log('\u2713 GSAP SVG tutorial interactive features initialized');
  }
